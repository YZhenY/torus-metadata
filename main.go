...
func main() {
	...
	handler := cors.New(cors.Options{MaxAge: 600, AllowedHeaders: []string{"Origin", "Accept", "Content-Type", "X-Requested-With", "x-api-key", "x-embed-host", "Authorization"}}).Handler(mr)
